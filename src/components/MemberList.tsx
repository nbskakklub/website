...
export default function TurnamentList({ members }: Props) {
  ...
  return (
    <Sheet variant="outlined" sx={{ borderRadius: '10px', padding: '0px', margin: '20px', maxHeight: '65vh', overflowX: 'hidden', overflowY: 'scroll', maxWidth: '1000px' }}>
      <Table stickyHeader sx={{ overflowX: 'hidden', maxHeight: '65vh' }} >
        <thead>
